...
const { validateDrugData, validateDrugUpdateData } = require('../middleware/validation');//import validation middleware
...
route.put('/api/drugs/:id', validateDrugUpdateData, controller.update);
